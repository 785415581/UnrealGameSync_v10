...
namespace UnrealGameSync
{
	partial class WorkspaceControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.NewestBianry = new System.Windows.Forms.ColumnHeader();
			...
			//this.BuildList.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.BuildList_MouseDoubleClick_Debug);
			...
			// StatusColumn
			// 
			this.NewestBianry.Text = "Newest Binary";
			this.NewestBianry.Width = 100;
			// 
			// panel1
			// 
		...
		private System.Windows.Forms.ColumnHeader NewestBianry;
